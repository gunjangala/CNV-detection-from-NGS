...
merged <- data.frame()
#if (length(pre.pindel)!=0){merged <- rbind(merged,pre.pindel)}
#if (length(pre.lumpy)!=0){merged <- rbind(merged,pre.lumpy)}
#if (length(pre.svaba)!=0){merged <- rbind(merged,pre.svaba)}
